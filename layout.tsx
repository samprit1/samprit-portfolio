...
export const metadata:Metadata={title:'SAMPRIT — Video Editor • Motion Graphics • Visual Design',description:'Professional video editing, motion graphics and visual design portfolio.'}
